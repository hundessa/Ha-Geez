    ...
    <>
      <div className="border-gray-500 border-[1px] w-[280px] ml-10 mr-4 flex justify-center rounded-lg pb-2">
        <div className="space-y-4">
          ...
          <div className="relative w-[260px] mx-auto mt-2">
            <img
              src={props.image}
              alt="course image"
              className="w-full h-[140px] object-cover"
            />
            <h1 className="absolute top-0 left-0 bg-slate-300 p-2">
              {props.category}
            </h1>
          </div>
          ...
          <div className="flex">
            ...
            <h1 className="flex justify-center mx-auto text-black">
              {props.price} Birr
            </h1>
          </div>
          <div className="justify-center flex">
            <Button
              variant="filed"
              className="bg-[#DDD] text-black font-semibold w-[200px] hover:bg-[#13569D] hover:text-white duration-300"
