...
{/* <div className="pt-6 mx-[4px] w-[390px]">
                <div>
                <div
                className="flex items-center space-x-2   h-10 cursor-pointer border-[1px] border-gray-400"
                onClick={contetClickedHandler}
                >
                <FaAngleUp className="mt-[2px] ml-2 size-[20px]" />
                ...
                Introduction to web
                    ...
                    <div className="flex flex-grow justify-end space-x-2 pr-2">
                    <h1 className="">1 lecture</h1>
                      <h1 className="">2min</h1>
                      </div>
                      </div>
                      <div
                ...
                <div>
                  <div className="flex items-center space-x-2 h-10 cursor-pointer border-[1px] border-gray-400 mt-[-1px]" onClick={contetClickedHandler}>
                    <FaAngleUp className="mt-[2px] ml-2 size-[20px]" />
...
//     return newStatus;
//   });
//   setLikeClicked((prevClicked) => !prevClicked);
...
//     return newStatus;
//   });
//   setDislikeClicked((prevClicked) => !prevClicked);
