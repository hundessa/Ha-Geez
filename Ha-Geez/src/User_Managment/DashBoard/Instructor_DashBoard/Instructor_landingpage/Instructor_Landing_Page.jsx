    ...
    <>
      ...
      <div className="absolute mt-20">
        <div className="flex bg-[#5A94D0] ml-[300px] bg-opacity-10 shadow-lg p-[15px] rounded-xl">
          ...
          <div>
            <Button color="#13569D" className="h-[80px] mt-12" onClick={() => navigate("/instructor/course_creation")}>
        ...
        <div className="flex">
          <div>
            <div>
              <div className="flex space-x-28 bg-[#5A94D0] bg-opacity-10 shadow-xl w-[450px] p-[20px] rounded-2xl ml-[100px] mt-8">
                ...
                <Button size="sm" color="#09355F" onClick={() => navigate("/instructor/student_list")}>
                  View List
                </Button>
              </div>
            </div>
          ...
          <div className="mb-10">
            <div className="flex space-x-28 bg-[#5A94D0] bg-opacity-10 shadow-xl w-[450px] p-[20px] rounded-2xl ml-[100px] mt-8">
              ...
              <Button size="sm" color="#09355F" onClick={() => navigate("/instructor/course_list")}>
                View List
              </Button>
            </div>
