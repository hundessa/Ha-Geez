  ...
  return (
    <>
      <div className="fixed mt-20 ml-20">
        ...
        >
          <Button variant="transparent" color="black" className="group relative" onClick={() => navigate("/instructor_course_creation")}>
            Intended Learners
          ...
          <Button variant="transparent" color="black" className="group relative" onClick={() => navigate("/instructor_course_creation/course_detail")}>
            Course Details
            <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-[4px] bg-blue-600 group-hover:w-[70%] transition-all"></span>
          </Button>
          <Button variant="transparent" color="black" className="group relative" onClick={() => navigate("/instructor_course_creation/course_content")}>
           Course Contents
            <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-[4px] bg-blue-600 group-hover:w-[70%] transition-all"></span>
          </Button>
